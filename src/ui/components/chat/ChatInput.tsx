...
export function ChatInput({ onSend, isLoading, selection = [] }: ChatInputProps) {
  ...
  return (
    <div className="bg-figma-bg px-3 pb-3 flex flex-col gap-2">
      ...
      <div className="flex flex-col gap-1 px-3 py-2 bg-figma-bg-secondary rounded-lg border border-transparent focus-within:border-figma-border-brand focus-within:ring-1 focus-within:ring-figma-border-brand transition-all">
        <textarea
          value={input}
